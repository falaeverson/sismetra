 ...
 *  @copyright Copyright 2013, CodEve Framework
 * 
 */
...
<html>
    <head>
        ...
        <title>Erro - CodEve Framework</title>
    ...
    <body>
        <header>
            <a href="#" id="logo">CodEve<span>*</span></a>
        </header>

        <section id="error">
            <h1>O CodEve* não conseguiu iniciar!</h1>
            <p>Você tem tudo o que precisa para rodar o CodEve*, entretanto, seu servidor não permite que as URLs sejam escritas. Você precisa definir a diretiva <strong>AllowOverride</strong> com pelo menos <strong>Options</strong> e <strong>FileInfo</strong> para que o CodEve* possa funcionar.</p>

        </section>

        <footer>
            <p>Obrigado por usar CodEve* :)</p>
        </footer>
    </body>
</html>